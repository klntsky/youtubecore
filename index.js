...
})(PS["Utils.FullScreen"] = PS["Utils.FullScreen"] || {});
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Utils.FullScreen"] = $PS["Utils.FullScreen"] || {};
  var exports = $PS["Utils.FullScreen"];
  var $foreign = $PS["Utils.FullScreen"];
  exports["listenForFullscreenExit"] = $foreign.listenForFullscreenExit;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var PlaybackReady = (function () {
      function PlaybackReady(value0) {
          this.value0 = value0;
      };
      PlaybackReady.create = function (value0) {
          return new PlaybackReady(value0);
      };
          ...
          if (state.playbackState instanceof PlaybackPlaying) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.kill(state.playbackState.value1))(function () {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $48.playbackState = new PlaybackPaused(new Data_Maybe.Just(state.playbackState.value0));
                      return $48;
                  })());
              });
          };
  ...
  var renderRecorderButton = function (state) {
      ...
      throw new Error("Failed pattern match at YTM.RecordableSlider (line 171, column 3 - line 199, column 26): " + [ state.recorderState.constructor.name ]);
  };
          ...
          return function (rawValue) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(shouldUpdate)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $70.lastSentValue = rawValue;
                      $70.lastAmplitude = v.amplitude;
                      return $70;
                  }))(function () {
      ...
      return function (recording) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(Control_Monad_Rec_Class.forever(Halogen_Query_HalogenM.monadRecHalogenM)(Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(recording)(function (entry) {
              ...
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $77.playbackState = new PlaybackPlaying(recording, forkId);
                  return $77;
              });
          });
      };
  ...
  var initialState = function (v) {
      return {
          ...
          playbackState: (function () {
              if (v.recording instanceof Data_Maybe.Nothing) {
                  return new PlaybackPaused(Data_Maybe.Nothing.value);
              };
      ...
      return function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (state.playbackState instanceof PlaybackPaused) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              var $159 = Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM);
                              var $160 = raiseValue(dictMonadAff)(FromUser.value);
                              return function ($161) {
                                  return $159($160($161));
                              };
                          })());
          ...
          if (v instanceof SetPlaybackSpeed) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $111.playbackSpeed = 1.0 / v.value0;
                  return $111;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
              });
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof Init) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.lastSentValue;
              }))(raiseValue(dictMonadAff)(FromPlayback.value))))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      return v1.playbackState;
                  }))(function (v1) {
                      if (v1 instanceof PlaybackReady) {
                          return startPlaybackProcess(dictMonadAff)(v1.value0);
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  });
              });
          ...
          if (v instanceof GetReadyToRecord) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $119.recorderState = ReadyToRecord.value;
                  return $119;
              });
          };
          if (v instanceof CancelRecording) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $122.recorderState = Inactive.value;
                  return $122;
              });
          };
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.now))(function (startTime) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(YTM_Slider.getValueFromEvent(dictMonadAff)(v.value0))(function (value) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                      ...
                                      $127.recorderState = new Recording(startTime, Data_List.singleton({
                                          relTime: Data_Newtype.wrap()(0.0),
                                          value: value
                                      }));
                                      $127.playbackState = new PlaybackPaused(Data_Maybe.Nothing.value);
                                      return $127;
                                  }))(function () {
                  ...
                  if (state.recorderState instanceof Inactive && state.playbackState instanceof PlaybackPaused) {
                      return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Web_UIEvent_MouseEvent.shiftKey(v.value0) || Web_UIEvent_MouseEvent.ctrlKey(v.value0))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(stopPlaybackProcess(dictMonadAff))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $130.constantValue = state.defaultValue;
                              return $130;
                          })()))(function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(startPlaybackProcess(dictMonadAff)(recordedEntries))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                          ...
                                          for (var $137 in state) {
                                              if ({}.hasOwnProperty.call(state, $137)) {
                                                  $136[$137] = state[$137];
                                              };
                                          };
                                          $136.recorderState = Inactive.value;
                                          return $136;
                                      }))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $156.playbackState = new PlaybackPaused(Data_Maybe.Nothing.value);
                          return $156;
                      }))(function () {
...
(function($PS) {
  ...
  var initialState = function (_value) {
      return _value;
  };
  var _volume = function (dictStrong) {
  ...
  var renderOpacityControl = function (dictMonadAff) {
      return function (opacity) {
          ...
          return Halogen_HTML_Elements.td([ Halogen_HTML_Properties.colSpan(2), Halogen_HTML_Properties.title("Video opacity coefficient") ])([ Halogen_HTML.slot()({
              reflectSymbol: function () {
              ...
              return function (volume) {
                  return function (recording) {
                      return function (elTitle) {
                          ...
                          return Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap()("slider-input-container")), Halogen_HTML_Properties.title(elTitle) ])([ Halogen_HTML.slot()({
                              reflectSymbol: function () {
                                  return "controls";
                              }
      ...
      return function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set(_settings(Data_Profunctor_Strong.strongFn))(v.value0.settings)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_FoldableWithIndex.forWithIndex_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Array_NonEmpty_Internal.foldableWithIndexNonEmptyArray)(v.value0.settings)(function (idx) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(UpdateValue.create(YTM_RecordableSlider.FromPlayback.value)(Data_Maybe.fromMaybe(0)(Data_Lens_Fold.previewOn(v.value0.settings)((function () {
                      var $55 = Data_Lens_Index.ix(Data_Lens_Index.indexNonEmptyArray)(0)(Data_Lens_Internal_Forget.strongForget)(Data_Lens_Internal_Forget.choiceForget(Data_Maybe_First.monoidFirst));
                      var $56 = _volume(Data_Lens_Internal_Forget.strongForget);
                      return function ($57) {
                          return $55($56($57));
                      };
                  })())))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(UpdateOpacity.create(v.value0.opacity)))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  });
              });
  ...
  var renderAmplitude = function (dictMonadAff) {
      return function (idx) {
          return function (amplitude) {
              ...
              return Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap()("slider-input-container")), Halogen_HTML_Properties.title("Amplitude of the slider to the left") ])([ Halogen_HTML.slot()({
                  reflectSymbol: function () {
                      return "amplitudeControls";
                  }
  ...
  var render = function (dictMonadAff) {
      return function (state) {
          var mkController = function (v) {
              return function (v1) {
                  return Halogen_HTML_Elements.tr_([ renderControl(dictMonadAff)(v1.value0)(v1.value1.value0)(v.volume)(v.recording)(v1.value1.value1), renderAmplitude(dictMonadAff)(v1.value0)(v.amplitude) ]);
              };
          };
          return Halogen_HTML_Elements.table_(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.zipWith(mkController)(Data_Array.fromFoldable(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(state.settings))([ new Data_Tuple.Tuple(0, new Data_Tuple.Tuple("VOL", "Video volume")), new Data_Tuple.Tuple(1, new Data_Tuple.Tuple("SPD", "Speed of video volume automation playback")), new Data_Tuple.Tuple(2, new Data_Tuple.Tuple("MOD", "Modulation of automation speed of the above slider")) ]))([ Halogen_HTML_Elements.tr_([ renderOpacityControl(dictMonadAff)(state.opacity) ]) ]));
      };
  };
      ...
      return function (v) {
              ...
              if (v.value1 instanceof YTM_RecordableSlider.UpdateValue && v.value1.value0 instanceof YTM_RecordableSlider.FromUser) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set((function () {
                          var $58 = _settings(Data_Profunctor_Strong.strongFn);
                          var $59 = Data_Lens_Index.ix(Data_Lens_Index.indexNonEmptyArray)(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $60 = _volume(Data_Profunctor_Strong.strongFn);
                          return function ($61) {
                              return $58($59($60($61)));
                          };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log(Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function ($62) {
                                  return Halogen_Query_HalogenM.raise(UpdateRecordingStates.create($62));
                              });
                          });
                      });
                  });
              ...
              if (v.value1 instanceof YTM_RecordableSlider.UpdateRecording) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log(Data_Show.show(Data_Show.showInt)(v.value0) + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set((function () {
                          var $63 = _settings(Data_Profunctor_Strong.strongFn);
                          var $64 = Data_Lens_Index.ix(Data_Lens_Index.indexNonEmptyArray)(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $65 = _recording(Data_Profunctor_Strong.strongFn);
                          return function ($66) {
                              return $63($64($65($66)));
                          };
                      })())(v.value1.value0)))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function ($67) {
                              return Halogen_Query_HalogenM.raise(UpdateRecordingStates.create($67));
                          });
                      });
                  });
              };
              throw new Error("Failed pattern match at YTM.VolumeControl (line 197, column 3 - line 214, column 50): " + [ v.value1.constructor.name ]);
          };
          if (v instanceof HandleAmplitude) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()({
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set((function () {
                      var $68 = _settings(Data_Profunctor_Strong.strongFn);
                      var $69 = Data_Lens_Index.ix(Data_Lens_Index.indexNonEmptyArray)(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                      var $70 = _amplitude(Data_Profunctor_Strong.strongFn);
                      return function ($71) {
                          return $68($69($70($71)));
                      };
                  })())(v.value1.value0)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function ($72) {
                          return Halogen_Query_HalogenM.raise(UpdateRecordingStates.create($72));
                      });
                  });
              });
          };
          if (v instanceof HandleOpacity) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new UpdateOpacity(v.value0.value0)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function ($73) {
                          return Halogen_Query_HalogenM.raise(UpdateRecordingStates.create($73));
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at YTM.VolumeControl (line 192, column 1 - line 195, column 64): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var UpdatePlayerSize = (function () {
      function UpdatePlayerSize(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      UpdatePlayerSize.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new UpdatePlayerSize(value0, value1, value2);
              };
          };
      };
      return UpdatePlayerSize;
  })();
  ...
  var CreateYouTubePlayer = (function () {
      ...
      CreateYouTubePlayer.value = new CreateYouTubePlayer();
  ...
  var updatePlayerVolume = function (dictMonadAff) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.player;
          }))(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function (player) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))($foreign.setVolume(player)(v.volume));
          }));
      });
  };
  ...
  var updatePlayerOpacity = function (dictMonadAff) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          var realOpacity = Data_Int.toNumber(v.volume * v.opacity | 0) / 10000.0;
          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))($foreign.setOpacity(playerIdToElementId(v.playerId))(realOpacity));
      });
  };
  ...
  var createYouTubePlayer = function (dictMonadAff) {
      return function (videoId) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(createPlayerElement(dictMonadAff)(v.playerId)(videoId)(v.volume))(function (player) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(Control_Monad_Rec_Class.forever(Halogen_Query_HalogenM.monadRecHalogenM)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Newtype.wrap()(500.0))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))($foreign.getVolume(player)))(function (newVolume) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  ...
                                  return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(oldVolume !== newVolume)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))($foreign.setVolume(player)(oldVolume)));
                              });
                          });
                      }))))(function (forkId) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof CreateYouTubePlayer) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.videoId;
              }))(createYouTubePlayer(dictMonadAff));
          };
  ...
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof StartVideo) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (state.player instanceof Data_Maybe.Nothing) {
                          return createYouTubePlayer(dictMonadAff)(v.value0);
                      };
                      if (state.player instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))($foreign.loadVideoById(state.player.value0)(v.value0)))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(loadVideoTitle(v.value0)))(function (title) {
                                  return Halogen_Query_HalogenM.raise(new SetTitle(title));
                              });
                          });
                      };
          ...
          if (v instanceof UpdatePlayerSize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.player;
              }))(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function (player) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))($foreign.setSize(player)(v.value0)(v.value1));
              })))(function () {
      ...
      return function (playerId) {
          return Halogen_Component.mkComponent({
              ...
              "eval": Halogen_Component.mkEval({
                  ...
                  handleQuery: handleQuery(dictMonadAff),
                  receive: Halogen_Component.defaultEval.receive,
                  initialize: new Data_Maybe.Just(CreateYouTubePlayer.value),
                  finalize: Halogen_Component.defaultEval.finalize
              })
          });
      };
  ...
  exports["UpdateOpacity"] = UpdateOpacity;
  exports["UpdatePlayerSize"] = UpdatePlayerSize;
  exports["mkComponent"] = mkComponent;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  ...
  var UpdateWindowSize = (function () {
      function UpdateWindowSize(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      UpdateWindowSize.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new UpdateWindowSize(value0, value1, value2);
              };
          };
      };
  ...
  var ExitFullscreen = (function () {
      function ExitFullscreen(value0) {
          this.value0 = value0;
      };
      ExitFullscreen.create = function (value0) {
          return new ExitFullscreen(value0);
      };
  ...
  var toVideoSize = function (isFullscreen) {
      return function (v) {
          var minCap = function (cap) {
              return function (x) {
                  if (x < cap) {
                      return cap;
                  };
  ...
  var getExistingPlayerIds = function (dictMonadAff) {
      return Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
          var $170 = Data_Array.mapMaybe(function (v) {
              if (v.value1.deleted) {
                  return Data_Maybe.Nothing.value;
              };
              return new Data_Maybe.Just(v.value0);
          });
          var $171 = Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray);
          return function ($172) {
              return $170($171((function (v) {
                  return v.videos;
              })($172)));
          };
      })());
  ...
  var initialState = function (hash) {
      var mbRoute = YTM_Routing.parse(hash);
      var defaultState = {
  ...
  var renderMixerEntry = function (dictMonadAff) {
      return function (v) {
          return function (v1) {
              ...
              })(Data_Ord.ordInt)(_volumeControl)(v)(YTM_VolumeControl.component(dictMonadAff))({
                  settings: v1.settings,
                  opacity: v1.opacity
              })(HandleVolumeControl.create(v)) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap()("mixer-video-title")) ])([ (function () {
                  if (v1.videoId instanceof Data_Either.Left) {
                      return Halogen_HTML_Core.text("");
                  };
                  if (v1.videoId instanceof Data_Either.Right) {
  ...
  var renderVideos = function (dictMonadAff) {
      return function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id("videos-container") ])(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.uncurry(renderVideo(dictMonadAff)(state)))(Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray)(state.videos)));
      };
  };
  var render = function (dictMonadAff) {
      return function (state) {
      ...
      return function (width) {
          return function (height) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                  ...
                  var v = toVideoSize(isFullscreen)({
                      width: width,
                      height: height
                  });
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getExistingPlayerIds(dictMonadAff))(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(function (ix) {
                          return Halogen_Query.tell()({
                              reflectSymbol: function () {
                                  return "embeds";
                              }
                          })(Data_Ord.ordInt)(_embeds)(ix)(YTM_YouTubeEmbed.UpdatePlayerSize.create(v.videoWidth)(v.videoHeight));
                      }));
                  });
              });
          };
      ...
      return function (v) {
          if (v instanceof AddVideo) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $100.videos = Data_Map_Internal.insert(Data_Ord.ordInt)(state.lastId)({
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.tell()({
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Newtype.wrap()(1.0))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          $106.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function (v2) {
          ...
          if (v instanceof HandleEmbedMessage) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $113.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($173) {
          ...
          if (v instanceof HandleVolumeControl) {
              ...
              if (v.value1 instanceof YTM_VolumeControl.UpdateRecordingStates) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $174 = Data_Lens_Setter.set((function () {
                          var $177 = _videos(Data_Profunctor_Strong.strongFn);
                          var $178 = Data_Lens_Index.ix(Data_Lens_Index.indexMap(Data_Ord.ordInt))(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $179 = YTM_VolumeControl["_opacity"](Data_Profunctor_Strong.strongFn);
                          return function ($180) {
                              return $177($178($179($180)));
                          };
                      })())(v.value1.value0.opacity);
                      var $175 = Data_Lens_Setter.set((function () {
                          var $181 = _videos(Data_Profunctor_Strong.strongFn);
                          var $182 = Data_Lens_Index.ix(Data_Lens_Index.indexMap(Data_Ord.ordInt))(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $183 = _settings(Data_Profunctor_Strong.strongFn);
                          return function ($184) {
          ...
          if (v instanceof UpdateVideoId) {
              ...
              if (v1 instanceof Data_Either.Left) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      var $133 = {};
                      for (var $134 in state) {
                          if ({}.hasOwnProperty.call(state, $134)) {
                              $133[$134] = state[$134];
                          };
                      };
                      $133.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($185) {
                          return Data_Maybe.Just.create((function (v3) {
                              ...
                              $130.videoId = new Data_Either.Left(v1.value0);
                              return $130;
                          })($185));
                      })(v.value0)(state.videos);
                      return $133;
              ...
              if (v1 instanceof Data_Either.Right) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $140.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($186) {
                          return Data_Maybe.Just.create((function (v3) {
                              var $137 = {};
                              for (var $138 in v3) {
                              ...
                              $137.videoId = new Data_Either.Right(v1.value0);
                              return $137;
                          })($186));
                      })(v.value0)(state.videos);
                      return $140;
          ...
          if (v instanceof FullScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))($foreign.requestFullscreen))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $146 = {};
                      for (var $147 in v1) {
                      ...
                      return updateWindowSize(dictMonadAff)(v1.width)(v1.height);
                  });
              });
          };
  ...
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          if (v instanceof UpdateFromURIHash) {
          ...
          if (v instanceof UpdateWindowSize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateWindowSize(dictMonadAff)(v.value0)(v.value1))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value2));
              });
          };
          if (v instanceof ExitFullscreen) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateWindowSize(dictMonadAff)(v1.width)(v1.height))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0));
                  });
              });
          };
...
(function($PS) {
  ...
  var Util_URIHash = $PS["Util.URIHash"];
  var Utils_FullScreen = $PS["Utils.FullScreen"];
  var Web_HTML = $PS["Web.HTML"];
  var Web_HTML_HTMLDocument = $PS["Web.HTML.HTMLDocument"];
  var Web_HTML_HTMLElement = $PS["Web.HTML.HTMLElement"];
  var Web_HTML_Window = $PS["Web.HTML.Window"];
  ...
  var getDocument = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)((function () {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(YTM_YouTubeAPI.awaitYouTubeAPI)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Util_URIHash.getHash))(function (hash) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(YTM_App.component(Effect_Aff_Class.monadAffAff))(hash)(body))(function (io) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_ResizeObserver.resizeObserver(function (entries) {
                      return function (v) {
                          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(entries)(function (entry) {
                              var width = Data_Int.floor(entry.contentRect.width);
                              var height = Data_Int.floor(entry.contentRect.height);
                              return Effect_Aff.launchAff_(io.query(new YTM_App.UpdateWindowSize(width, height, Data_Unit.unit)));
                          });
                      };
                  })))(function (observer) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(getDocument))(function (document) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Maybe.maybe(Effect_Exception["throw"]("no document"))(Control_Applicative.pure(Effect.applicativeEffect))(Web_HTML_HTMLDocument.fromDocument(document))))(function (htmlDocument) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Bind.bind(Effect.bindEffect)(Web_HTML_HTMLDocument.body(htmlDocument))(Data_Maybe.maybe(Effect_Exception["throw"]("no document body"))(Control_Applicative.pure(Effect.applicativeEffect)))))(function (bd) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_ResizeObserver.observe()()(Web_HTML_HTMLElement.toElement(bd))({})(observer)))(function () {
                                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Utils_FullScreen.listenForFullscreenExit(Effect_Aff.launchAff_(io.query(new YTM_App.ExitFullscreen(Data_Unit.unit)))));
                                  });
                              });
                          });
                      });
