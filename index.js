...
(function($PS) {
  ...
  var loadVideoTitle = (function () {
      var $61 = Data_Functor.map(Effect_Aff.functorAff)(Data_Maybe.fromMaybe("[EMBEDDING NOT ALLOWED]"));
      var $62 = $foreign.loadVideoTitle_(Data_Maybe.Just.create)(Data_Maybe.Nothing.value);
      return function ($63) {
          return $61(Control_Promise.toAffE($62($63)));
      };
  })();
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updatePlayerOpacity(dictMonadAff))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(Control_Monad_Rec_Class.forever(Halogen_Query_HalogenM.monadRecHalogenM)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Newtype.wrap()(500.0))))(function () {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                              ...
                              $37.player = new Data_Maybe.Just(player);
                              $37.bgTask = new Data_Maybe.Just(forkId);
                              return $37;
                          }))(function () {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at YTM.YouTubeEmbed (line 173, column 16 - line 179, column 41): " + [ v.constructor.name ]);
      };
  };
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof StartVideo) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at YTM.YouTubeEmbed (line 111, column 3 - line 116, column 31): " + [ state.player.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                  });
              });
          ...
          if (v instanceof KillPlayer) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  var $64 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                  return function ($65) {
                      return $64($foreign.destroyPlayer($65));
                  };
              })())))(function () {
          ...
          if (v instanceof PauseVideo) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  var $66 = Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()));
                  return function ($67) {
                      return $66($foreign.pausePlayer($67));
                  };
              })())))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0));
              });
          ...
          if (v instanceof ResumeVideo) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return function ($69) {
                      return $68($foreign.resumePlayer($69));
                  };
              })())))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0));
              });
          ...
          throw new Error("Failed pattern match at YTM.YouTubeEmbed (line 99, column 1 - line 103, column 55): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var getExistingPlayerIds = function (dictMonadAff) {
      return Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
          var $118 = Data_Array.mapMaybe(function (v) {
              if (v.value1.deleted) {
                  return Data_Maybe.Nothing.value;
              };
              return new Data_Maybe.Just(v.value0);
          });
          var $119 = Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray);
          return function ($120) {
              return $118($119((function (v) {
                  return v.videos;
              })($120)));
          };
      })());
  ...
  var initialState = function (hash) {
      ...
      throw new Error("Failed pattern match at YTM.App (line 103, column 3 - line 105, column 48): " + [ mbRoute.constructor.name ]);
  };
      ...
      return function (v) {
          return function (v1) {
              ...
              var shortenedTitle = (function () {
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 239, column 7 - line 242, column 39): " + [ v2.constructor.name ]);
              })();
              return [ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap()("mixer-video-input-container")) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_(Data_Newtype.wrap()("mixer-video-input")), Halogen_HTML_Properties.placeholder("Video URL or ID"), Halogen_HTML_Properties.value((function () {
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 204, column 20 - line 206, column 53): " + [ v1.videoId.constructor.name ]);
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 223, column 9 - line 231, column 40): " + [ v1.videoId.constructor.name ]);
      ...
      return function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.tell()({
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Newtype.wrap()(1.0))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          ...
                          $62.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function (v2) {
          ...
          if (v instanceof HandleEmbedMessage) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $69.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($121) {
          ...
          if (v instanceof HandleVolumeControl) {
              if (v.value1 instanceof YTM_VolumeControl.UpdateValue) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()({
                      ...
                      throw new Error("Failed pattern match at YTM.App (line 298, column 9 - line 305, column 22): " + [ v.value1.value0.constructor.name ]);
                  });
              };
              if (v.value1 instanceof YTM_VolumeControl.UpdateRecordingStates) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $122 = Data_Lens_Setter.set((function () {
                          var $125 = _videos(Data_Profunctor_Strong.strongFn);
                          var $126 = Data_Lens_Index.ix(Data_Lens_Index.indexMap(Data_Ord.ordInt))(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $127 = YTM_VolumeControl["_opacity"](Data_Profunctor_Strong.strongFn);
                          return function ($128) {
                              return $125($126($127($128)));
                          };
                      })())(v.value1.value0.opacity);
                      var $123 = Data_Lens_Setter.set((function () {
                          var $129 = _videos(Data_Profunctor_Strong.strongFn);
                          var $130 = Data_Lens_Index.ix(Data_Lens_Index.indexMap(Data_Ord.ordInt))(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $131 = _settings(Data_Profunctor_Strong.strongFn);
                          return function ($132) {
              ...
              throw new Error("Failed pattern match at YTM.App (line 293, column 5 - line 314, column 90): " + [ v.value1.constructor.name ]);
          };
          if (v instanceof UpdateVideoId) {
              ...
              if (v1 instanceof Data_Either.Left) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $89.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($133) {
                          return Data_Maybe.Just.create((function (v3) {
                              ...
                              $86.videoId = new Data_Either.Left(v1.value0);
                              return $86;
                          })($133));
                      })(v.value0)(state.videos);
                      return $89;
              ...
              if (v1 instanceof Data_Either.Right) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $96.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($134) {
                          return Data_Maybe.Just.create((function (v3) {
                              var $93 = {};
                              for (var $94 in v3) {
                              ...
                              $93.videoId = new Data_Either.Right(v1.value0);
                              return $93;
                          })($134));
                      })(v.value0)(state.videos);
                      return $96;
              ...
              throw new Error("Failed pattern match at YTM.App (line 317, column 5 - line 332, column 18): " + [ v1.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at YTM.App (line 245, column 16 - line 342, column 20): " + [ v.constructor.name ]);
      };
  };
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(function __do() {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 382, column 3 - line 397, column 45): " + [ mbRoute.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
              });
          });
      ...
      return function (idx) {
          return function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.ref(Data_Newtype.wrap()(Data_Show.show(Data_Show.showInt)(idx))), Halogen_HTML_Properties.class_(Data_Newtype.wrap()("video-container")), Halogen_HTML_Properties.style("opacity: " + Data_Show.show(Data_Show.showNumber)(Data_Int.toNumber(100) / 100.0)), Halogen_HTML_Properties.id("tmp-" + Data_Show.show(Data_Show.showInt)(idx)) ])([ (function () {
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 160, column 5 - line 169, column 34): " + [ v.videoId.constructor.name ]);
              })() ]);
          };
      };
  };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(YTM_YouTubeAPI.awaitYouTubeAPI)(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Util_URIHash.getHash))(function (hash) {
              return Halogen_VDom_Driver.runUI(YTM_App.component(Effect_Aff_Class.monadAffAff))(hash)(body);
          });
      });
  }));
  exports["main"] = main;
