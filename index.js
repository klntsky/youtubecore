...
(function($PS) {
  ...
  var setHash = function (v) {
      ...
      return function __do() {
          ...
          return Web_HTML_Location.setHash(Data_Maybe.fromMaybe("")(JSURI["encodeURIComponent"](v)))(location)();
      };
  };
  var getHash = function __do() {
      ...
      return Data_Maybe.fromMaybe("")(JSURI["decodeURIComponent"](hash));
  };
...
(function($PS) {
  ...
  var $$parseInt = Control_Bind.bind(Text_Parsing_StringParser.bindParser)(Data_Functor.map(Text_Parsing_StringParser.functorParser)(Data_Int.fromString)(Text_Parsing_StringParser_CodePoints.regex("[0-9]+")))(function (mbInt) {
      ...
      throw new Error("Failed pattern match at YTM.Routing (line 106, column 3 - line 108, column 21): " + [ mbInt.constructor.name ]);
  });
  ...
  var parseSettings = (function () {
      var nonEmptyListToArray = (function () {
          var $10 = Data_NonEmpty.fromNonEmpty(function (a) {
              var $13 = Data_NonEmpty.NonEmpty.create(a);
              var $14 = Data_Array.fromFoldable(Data_List_Types.foldableList);
              return function ($15) {
                  return Data_Array_NonEmpty.fromNonEmpty($13($14($15)));
              };
          });
  ...
  var routeParser = Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_StringParser.bindParser)(Data_Functor["void"](Text_Parsing_StringParser.functorParser)(Text_Parsing_StringParser_CodePoints["char"]("#")))(function () {
      return Control_Alt.alt(Text_Parsing_StringParser.altParser)(currentRouteParser)(legacyRouteParser);
  });
  var parse = (function () {
      var $16 = Text_Parsing_StringParser.runParser(routeParser);
      return function ($17) {
...
(function($PS) {
  ...
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set(_settings(Data_Profunctor_Strong.strongFn))(v.value0)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_FoldableWithIndex.forWithIndex_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Array_NonEmpty_Internal.foldableWithIndexNonEmptyArray)(v.value0)(function (idx) {
                  return function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(v1.recording)(function (recording) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()({
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()({
                                  ...
                                  })(Data_Ord.ordInt)(_amplitudeControls)(idx)(Halogen_Query.mkTell(YTM_Slider.PutValue.create(v1.amplitude))));
                              });
                          });
                      });
                  };
      ...
      return function (v) {
          if (v instanceof HandleControl) {
              if (v.value1 instanceof YTM_RecordableSlider.UpdateValue && v.value1.value0 instanceof YTM_RecordableSlider.FromUser) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set((function () {
                          var $41 = _settings(Data_Profunctor_Strong.strongFn);
                          var $42 = Data_Lens_Index.ix(Data_Lens_Index.indexNonEmptyArray)(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $43 = _volume(Data_Profunctor_Strong.strongFn);
                          return function ($44) {
                              return $41($42($43($44)));
                          };
                      })())(v.value1.value2)))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function ($45) {
                              return Halogen_Query_HalogenM.raise(UpdateRecordingStates.create((function (v1) {
                                  return v1.settings;
                              })($45)));
                          });
                      });
              ...
              if (v.value1 instanceof YTM_RecordableSlider.UpdateRecording) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log(Data_Show.show(Data_Show.showInt)(v.value0) + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons({
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set((function () {
                          var $46 = _settings(Data_Profunctor_Strong.strongFn);
                          var $47 = Data_Lens_Index.ix(Data_Lens_Index.indexNonEmptyArray)(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                          var $48 = _recording(Data_Profunctor_Strong.strongFn);
                          return function ($49) {
                              return $46($47($48($49)));
                          };
                      })())(v.value1.value0)))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function ($50) {
                              return Halogen_Query_HalogenM.raise(UpdateRecordingStates.create((function (v1) {
                                  return v1.settings;
                              })($50)));
                          });
              ...
              throw new Error("Failed pattern match at YTM.VolumeControl (line 189, column 3 - line 207, column 65): " + [ v.value1.constructor.name ]);
          };
          if (v instanceof HandleAmplitude) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()({
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set((function () {
                      var $51 = _settings(Data_Profunctor_Strong.strongFn);
                      var $52 = Data_Lens_Index.ix(Data_Lens_Index.indexNonEmptyArray)(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                      var $53 = _amplitude(Data_Profunctor_Strong.strongFn);
                      return function ($54) {
                          return $51($52($53($54)));
                      };
                  })())(v.value1.value0)))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function ($55) {
                          return Halogen_Query_HalogenM.raise(UpdateRecordingStates.create((function (v1) {
                              return v1.settings;
                          })($55)));
                      });
          ...
          if (v instanceof HandleOpacity) {
              return Halogen_Query_HalogenM.raise(new UpdateOpacity(v.value0.value0));
          };
          throw new Error("Failed pattern match at YTM.VolumeControl (line 184, column 1 - line 187, column 64): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var createPlayerElement = function (dictMonadEffect) {
      return function (playerId) {
          return function (videoId) {
              return function (volume) {
                  return Effect_Class.liftEffect(dictMonadEffect)($foreign.newYouTubePlayer(playerIdToElementId(playerId))(videoId)(volume));
              };
          };
      };
  };
  var createYouTubePlayer = function (dictMonadEffect) {
      return function (dictMonadAff) {
          return function (playerId) {
              return function (videoId) {
                  return function (volume) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(createPlayerElement(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(playerId)(videoId)(volume))(function (player) {
      ...
      return function (playerId) {
          return function (v) {
              if (v instanceof CreateYouTubePlayer) {
                  return createYouTubePlayer(dictMonadAff.MonadEffect0())(dictMonadAff)(playerId)(v.value0)(v.value1);
              };
              ...
              throw new Error("Failed pattern match at YTM.YouTubeEmbed (line 153, column 25 - line 159, column 41): " + [ v.constructor.name ]);
          };
      };
  };
  var handleQuery = function (dictMonadAff) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          if (state.player instanceof Data_Maybe.Nothing) {
                              return createYouTubePlayer(dictMonadAff.MonadEffect0())(dictMonadAff)(v)(v1.value0)(state.volume);
                          };
...
(function($PS) {
  ...
  var getExistingPlayerIds = function (dictMonadAff) {
      return Data_Functor.mapFlipped(Halogen_Query_HalogenM.functorHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))((function () {
          var $114 = Data_Array.mapMaybe(function (v) {
              if (v.value1.deleted) {
                  return Data_Maybe.Nothing.value;
              };
              return new Data_Maybe.Just(v.value0);
          });
          var $115 = Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray);
          return function ($116) {
              return $114($115((function (v) {
                  return v.videos;
              })($116)));
          };
      })());
      ...
      return function (v) {
          return function (v1) {
              ...
              var shortenedTitle = (function () {
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 223, column 7 - line 226, column 39): " + [ v2.constructor.name ]);
              })();
              return [ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap()("mixer-video-input-container")) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_(Data_Newtype.wrap()("mixer-video-input")), Halogen_HTML_Properties.placeholder("Video URL or ID"), Halogen_HTML_Properties.value((function () {
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 190, column 20 - line 192, column 53): " + [ v1.videoId.constructor.name ]);
              ...
              })(Data_Ord.ordInt)(_volumeControl)(v)(YTM_VolumeControl.component(dictMonadAff))(0)(HandleVolumeControl.create(v)) ]) ]), Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.class_(Data_Newtype.wrap()("mixer-video-title")) ])([ (function () {
                  if (v1.videoId instanceof Data_Either.Left) {
                      return Halogen_HTML_Core.text("");
                  };
                  if (v1.videoId instanceof Data_Either.Right) {
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 207, column 9 - line 215, column 40): " + [ v1.videoId.constructor.name ]);
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof HandleEmbedMessage) {
              ...
              if (v.value1 instanceof YTM_YouTubeEmbed.SetTitle) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $68.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($117) {
              ...
              throw new Error("Failed pattern match at YTM.App (line 280, column 5 - line 298, column 18): " + [ v.value1.constructor.name ]);
          };
          if (v instanceof HandleVolumeControl) {
              if (v.value1 instanceof YTM_VolumeControl.UpdateValue) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()({
                      ...
                      throw new Error("Failed pattern match at YTM.App (line 306, column 9 - line 313, column 22): " + [ v.value1.value0.constructor.name ]);
                  });
              };
              if (v.value1 instanceof YTM_VolumeControl.UpdateRecordingStates) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set((function () {
                      var $118 = _videos(Data_Profunctor_Strong.strongFn);
                      var $119 = Data_Lens_Index.ix(Data_Lens_Index.indexMap(Data_Ord.ordInt))(v.value0)(Data_Profunctor_Strong.strongFn)(Data_Profunctor_Choice.choiceFn);
                      var $120 = _settings(Data_Profunctor_Strong.strongFn);
                      return function ($121) {
                          return $118($119($120($121)));
                      };
                  })())(v.value1.value0)))(function () {
                      return updateURL(dictMonadAff);
                  });
              ...
              throw new Error("Failed pattern match at YTM.App (line 301, column 5 - line 319, column 90): " + [ v.value1.constructor.name ]);
          };
          if (v instanceof UpdateVideoId) {
              ...
              if (v1 instanceof Data_Either.Left) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $86.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($122) {
                          return Data_Maybe.Just.create((function (v3) {
                              ...
                              $83.videoId = new Data_Either.Left(v1.value0);
                              return $83;
                          })($122));
                      })(v.value0)(state.videos);
                      return $86;
              ...
              if (v1 instanceof Data_Either.Right) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      ...
                      $93.videos = Data_Map_Internal.update(Data_Ord.ordInt)(function ($123) {
                          return Data_Maybe.Just.create((function (v3) {
                              var $90 = {};
                              for (var $91 in v3) {
                              ...
                              $90.videoId = new Data_Either.Right(v1.value0);
                              return $90;
                          })($123));
                      })(v.value0)(state.videos);
                      return $93;
              ...
              throw new Error("Failed pattern match at YTM.App (line 322, column 5 - line 337, column 18): " + [ v1.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at YTM.App (line 229, column 16 - line 347, column 20): " + [ v.constructor.name ]);
      };
  };
  var handleQuery = function (dictMonadAff) {
      return function (v) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(function __do() {
              ...
              })(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Time_Duration.showMilliseconds))))))(Data_Show.showInt))))))))(mbRoute))();
          }))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Newtype.wrap()(1000.0))))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                                          return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray)(state.videos))(function (v1) {
                                              ...
                                              })(Data_Ord.ordInt)(_volumeControl)(v1.value0)(YTM_VolumeControl.PutRecordings.create(v1.value1.settings));
                                          });
                                      });
                                  });
                              });
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 386, column 3 - line 400, column 63): " + [ mbRoute.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
              });
          });
          ...
          return function (v) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.ref(Data_Newtype.wrap()(Data_Show.show(Data_Show.showInt)(idx))), Halogen_HTML_Properties.class_(Data_Newtype.wrap()("video-container")), Halogen_HTML_Properties.style("opacity: " + Data_Show.show(Data_Show.showNumber)(Data_Int.toNumber(100) / 100.0)), Halogen_HTML_Properties.id("tmp-" + Data_Show.show(Data_Show.showInt)(idx)) ])([ (function () {
                  if (v.videoId instanceof Data_Either.Left) {
                      return Halogen_HTML_Core.text("Invalid video id");
                  };
                  ...
                  throw new Error("Failed pattern match at YTM.App (line 149, column 5 - line 155, column 34): " + [ v.videoId.constructor.name ]);
              })() ]);
          };
      };
  };
